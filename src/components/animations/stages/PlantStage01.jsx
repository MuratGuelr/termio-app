...
// Stage 01: Seedling (levels 1-4)
// Renders the provided 512x512 SVG scaled into 120x120 with a ground-aligned growth mask.
// Props: growth (0..1), miniProgress (0..1), timerColor, className, stageScale
export default function PlantStage01({ growth = 0, miniProgress = 0, timerColor = '#10b981', className = 'plant-svg', stageScale = 0.9 }) {
  ...
  // Smooth internal tween for growth
  useEffect(() => {
  ...
  // Scale the 512 SVG into 120 viewBox
  const s = (120 / 512) * stageScale;
  const tx = 60 - (256 * s);
  const ty = 100 - (512 * s);
  ...
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true" focusable="false">
      <defs>
        <radialGradient id="groundGradStage01" cx="50%" cy="78%" r="60%">
      ...
      {/* Ground ellipse */}
      <ellipse cx={cx} cy={cy} rx={rx} ry={ry} fill="url(#groundGradStage01)" />
      ...
      {/* Stage 01 group masked */}
      <g mask={`url(#${maskId})`}>
        <g transform={`translate(${tx} ${ty}) scale(${s})`}>
          {/* Provided SVG paths */}
          <path fill="#6DC82A" d="M282.915,211.33c-3.863,4.077-9.324,6.225-14.941,5.877c-1.943-0.123-48.129-3.298-95.369-28.754
  ...
  c19.446,29.566,31.786,65.589,36.678,107.066C288.63,201.671,286.777,207.252,282.915,211.33z"/>
          <path fill="#5EAC24" d="M251.887,89.963c-7.938,14.65-14.633,31.15-19.437,49.738c-4.32,12.902-10.917,35.57-16.362,66.933
  ...
  C283.13,155.048,270.983,119.354,251.887,89.963z"/>
          <path fill="#4E901E" d="M266.674,178.855l-40.788-39.775L215.13,85.482c-0.851-4.248-4.984-6.997-9.233-6.147
  ...
  c2.04,0,4.078-0.792,5.617-2.368C269.837,186.843,269.775,181.878,266.674,178.855z"/>
          <path fill="#91DC5A" d="M467.824,5.914c-3.863-4.077-9.324-6.225-14.941-5.877c-1.943,0.123-48.129,3.298-95.369,28.754
  ...
  C473.539,15.573,471.686,9.992,467.824,5.914z"/>
          <path fill="#5EAC24" d="M443.129,27.307c-3.026-3.101-7.991-3.164-11.091-0.14L379.55,78.35l6.392-31.851
  ...
  c-0.046,0-0.092,0-0.137,0.001l-40.264,0.688l57.719-56.284C446.091,35.373,446.153,30.408,443.129,27.307z"/>
          <path fill="#CC7400" d="M449.193,410.125c-7.91,0-15.298,2.228-21.577,6.087c-9.274-30.342-37.491-52.414-70.869-52.414
  ...
  c7.557,8.434,18.529,13.744,30.744,13.744c22.795,0,41.275-18.48,41.275-41.275C490.468,428.604,471.988,410.125,449.193,410.125z"/>
          <g>
            <path fill="#AA6100" d="M309.888,345.918c9.748,0,19.154,1.443,28.042,4.092c-17.525-26.63-47.666-44.221-81.928-44.221
    ...
    z"/>
            <circle fill="#AA6100" cx="294.986" cy="421.014" r="17.771"/>
            <circle fill="#AA6100" cx="366.638" cy="462.863" r="17.771"/>
            <circle fill="#AA6100" cx="355.71" cy="402.055" r="6.838"/>
            <circle fill="#AA6100" cx="256.002" cy="469.702" r="6.838"/>
            <circle fill="#AA6100" cx="277.209" cy="376.498" r="6.838"/>
            <circle fill="#AA6100" cx="424.351" cy="438.791" r="6.838"/>
          </g>
          <g>
            <circle fill="#CC7400" cx="384.415" cy="317.216" r="17.771"/>
            <circle fill="#CC7400" cx="424.351" cy="356.953" r="6.838"/>
            <circle fill="#CC7400" cx="424.351" cy="324.055" r="6.838"/>
          </g>
          <g>
            <circle fill="#AA6100" cx="112.53" cy="310.942" r="17.771"/>
            <circle fill="#AA6100" cx="83.02" cy="350.115" r="6.838"/>
          </g>
        </g>
      </g>
    </svg>
